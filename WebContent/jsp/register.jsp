...
<div class="container" style="width:100%;background:url('/store/image/regist_bg.jpg');">
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" method="post" action="/store/user">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <input type="submit"  width="100" value="注册" name="submit" border="0"
				    style="background: url('/store/images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
