		...
		<div class="container">
							...
							<c:forEach items="${cart.map}" var="mm">
								<tr class="active">
									<td width="60" width="40%">
										...
										<img src="/store/${mm.value.product.pimage}" width="70" height="60">
									</td>
									<td width="30%">
									...
									<td>
										<a href="/store/cart?method=remove&pid=${mm.key}" class="delete">删除</a>
									</td>
								</tr>
							</c:forEach>
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="/store/cart?method=removeAll" id="clear" class="clear">清空购物车</a>
					<a href="/store/order?method=addOrder">
						<input type="button" width="100" value="提交订单" name="submit" border="0" style="background: url('/store/images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
