...
<div class="container"  style="width:100%;height:460px;background:#FF2C4C url('/store/images/loginbg.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
	...
	<div class="col-md-5">
				...
				<div>&nbsp;</div>
<form class="form-horizontal" action="/store/user" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <img src="/store/image/captcha.jhtml"/>
    </div>
  ...
  <div class="form-group">
    ...
    style="background: url('/store/images/login.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
