...
<HTML>
	<HEAD>
		...
		<LINK href="/store/css/Style1.css" type="text/css" rel="stylesheet">
	</HEAD>
	
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="/store/adminProduct_update.action" method="post" enctype="multipart/form-data">
