...
<title>菜单</title>
<link href="/store/css/left.css" rel="stylesheet" type="text/css"/>
<link rel="StyleSheet" href="/store/css/dtree.css" type="text/css" />
</head>
<body>
...
<div class="dtree">
	...
	<script type="text/javascript" src="/store/js/dtree.js"></script>
